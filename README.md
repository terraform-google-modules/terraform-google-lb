...
| <a name="input_hc_fw_name"></a> [hc\_fw\_name](#input\_hc\_fw\_name) | Name for the firewall rule for health check. | `string` | `""` | no |
...
| <a name="input_health_check_name"></a> [health\_check\_name](#input\_health\_check\_name) | Name for the health check. | `string` | `""` | no |
...
| <a name="input_lb_fw_name"></a> [lb\_fw\_name](#input\_lb\_fw\_name) | Name for the firewall rule for LB. | `string` | `""` | no |
| <a name="input_name"></a> [name](#input\_name) | Name for the forwarding rule. It will be used as prefix for supporting resources if input for health check, target pool and firewall rules names not are provided. | `string` | n/a | yes |
...
| <a name="input_target_pool_name"></a> [target\_pool\_name](#input\_target\_pool\_name) | Name for the target pool name. | `string` | `""` | no |
